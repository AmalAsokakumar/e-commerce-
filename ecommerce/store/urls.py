...
# category views
from .views import add_category, upload_pic, view_category, edit_category, delete_category
# brand views
from .views import add_brand, upload_pic_, view_brand, delete_brand, edit_brand
# product views
from .views import add_product, upload_pic_pro, view_product, delete_product, edit_product
# store view
